package 
{
	...
	import com.example.programmingas3.algorithmic.MyControlPanel;
	...
	{
		public var controlPanel:MyControlPanel= new MyControlPanel();
		...
		private function init(e:Event = null):void 
		{
			...
			// entry point
			controlPanel.width = 550;
			controlPanel.height = 120;
			controlPanel.scaleX = 1;
			controlPanel.scaleY = 1;
			addChild(controlPanel);
			MyAlgorithmicVisualGenerator();


		}
		
		private function MyAlgorithmicVisualGenerator():void {
