package com.example.programmingas3.filterWorkbench
{
	...
	{
		public static const IMAGE1:ImageType = new ImageType("位图1", "images/sampleImage1.jpg");
		public static const IMAGE2:ImageType = new ImageType("位图2", "images/sampleImage2.jpg");
		public static const SWF:ImageType = new ImageType("SWF动画", "images/sampleAnimation.swf");
